...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'middleware' => 'auth.isAdmin'], function () {
    ...
    Route::get('{event}/bay-management/matrix-partial', [App\Http\Controllers\Event\BayManagementController::class, 'getMatrixPartial'])
        ->name('events.bay-management.matrix-partial');
